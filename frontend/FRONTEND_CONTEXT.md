...
This file contains the text-based frontend source and public assets for the React app in this workspace.

Omitted files:
- Binary assets: `public/favicon.ico`, `public/logo192.png`, `public/logo512.png`
- Generated/dependency content: `node_modules/`, build outputs, and other non-source artifacts
...
You don't have to ever use `eject`. The curated feature set is suitable for small and middle deployments, and you shouldn't feel obligated to use this feature. However we understand that this feature wouldn't be useful if you couldn't customize it when you are ready for it.
...
export const TextNode = createNode('text'); // you'll extend this one, see below
```
...
export const nodeConfigs = {
  ...
  llm: {
    ...
    fields: [],
    handles: [
      { type: 'target', id: 'system', position: 'left', style: { top: '30%' } },
      { type: 'target', id: 'prompt', position: 'left', style: { top: '70%' } },
  ...
  text: {
    title: 'Text',
    fields: [
      { name: 'text', label: '', type: 'textarea', default: '{{input}}' },
    ],
    handles: [], // dynamic — handled specially, see Part 3 below
  },
};
```
